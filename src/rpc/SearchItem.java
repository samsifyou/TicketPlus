...
public class SearchItem extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		 ...
		 * out.println("<html><body>"); out.println("<h1>Hello World</h1>");
		 ...
		 * request.getParameter("username"); out.println("<html><body>");
		 ...
		 * response.getWriter(); if (request.getParameter("username") != null) { String
		 * username = request.getParameter("username"); JSONObject obj = new
		 * JSONObject(); try { obj.put("username", username); obj.put("password",
		 * "I can't tell you"); } catch (JSONException e) { e.printStackTrace(); }
		 ...
		 * 
		 * try { array.put(new JSONObject().put("username", "abcde")); array.put(new
		 * JSONObject().put("username", "12345")); } catch (JSONException e) {
		 * e.printStackTrace(); }
		 * 
